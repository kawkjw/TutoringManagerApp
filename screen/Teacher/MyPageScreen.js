...
import DailyRecordList from "./MyPage/DailyRecordList";
...
const MyPageStackScreen = ({ navigation, route }) => {
    return (
        <MyPageStack.Navigator>
            ...
            <MyPageStack.Screen options={{ title: "수업 일지 목록" }} name="DailyRecordList" component={DailyRecordList} />
            <MyPageStack.Screen options={{ title: "수업 일지" }} name="DailyRecord" component={DailyRecord} />
        </MyPageStack.Navigator>
    );
};
